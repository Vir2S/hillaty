class Price:
    EXCHANGE_RATES = {"USD": 1, "UAH": 0.036, "GBP": 1.39}  # exchange rates as of May 1st, 2023
    ...
    def __add__(self, other: 'Price') -> 'Price':
        if self.currency != other.currency:
            amount_in_usd = self._convert_to_usd(self.amount, self.currency) + self._convert_to_usd(other.amount, other.currency)
